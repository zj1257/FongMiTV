...
public class Sniffer {
    ...
    public static final Pattern SNIFFER = Pattern.compile("http((?!http).){12,}?\\.(m3u8|mp4|mkv|flv|mp3|m4a|aac|mpd|php)\\?.*|http((?!http).){12,}\\.(m3u8|mp4|mkv|flv|mp3|m4a|aac|mpd|php)|http((?!http).)*?video/tos*|http((?!http).)*?obj/tos*");
